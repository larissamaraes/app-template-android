...
public abstract class BaseViewModel extends androidx.lifecycle.ViewModel implements androidx.lifecycle.LifecycleObserver {
    ...
    private final androidx.lifecycle.MutableLiveData<com.jera.apptemplate.util.viewmodel.Placeholder> placeholderLiveData = null;
    private final androidx.lifecycle.MutableLiveData<com.jera.apptemplate.util.arch.Event<com.jera.apptemplate.util.navigation.NavData>> goToLiveData = null;
    private final androidx.lifecycle.MutableLiveData<com.jera.apptemplate.util.arch.Event<com.jera.apptemplate.util.viewmodel.DialogData>> dialogLiveData = null;
    private final androidx.lifecycle.MutableLiveData<com.jera.apptemplate.util.arch.Event<java.lang.String>> toastLiveData = null;
    ...
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.LiveData<com.jera.apptemplate.util.viewmodel.Placeholder> getPlaceholder() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.LiveData<com.jera.apptemplate.util.arch.Event<com.jera.apptemplate.util.navigation.NavData>> getGoTo() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.LiveData<com.jera.apptemplate.util.arch.Event<com.jera.apptemplate.util.viewmodel.DialogData>> getDialog() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.LiveData<com.jera.apptemplate.util.arch.Event<java.lang.String>> getToast() {
        return null;
    }
