...
public final class ActivityExtensionsKt {
    ...
    androidx.appcompat.app.AppCompatActivity $receiver, @org.jetbrains.annotations.Nullable()
    androidx.appcompat.widget.Toolbar toolbar, boolean showHome, @org.jetbrains.annotations.Nullable()
    java.lang.String title) {
    }
    
    private static final void setupToolbar(@org.jetbrains.annotations.NotNull()
    androidx.appcompat.app.AppCompatActivity $receiver, androidx.appcompat.widget.Toolbar toolbar, boolean showHome) {
    }
    
    private static final void setupToolbarWithTitle(@org.jetbrains.annotations.NotNull()
    androidx.appcompat.app.AppCompatActivity $receiver, androidx.appcompat.widget.Toolbar toolbar, java.lang.String title, boolean showHome) {
    }
